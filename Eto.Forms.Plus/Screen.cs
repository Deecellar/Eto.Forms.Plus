...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        void IViewAware.AttachView(Control view)
        {
            ...
            {
                if (viewAsFrameworkElement.Loaded)
                    this.OnViewLoaded();
                else
                    viewAsFrameworkElement.Load += (o, e) => this.OnViewLoaded();
            }
        }
